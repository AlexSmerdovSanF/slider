...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1F1E24);
  late Color secondary = const Color(0xFFF1F200);
  late Color tertiary = const Color(0xB2FFFFFF);
  late Color alternate = const Color(0xFFFFE6CF);
  late Color primaryText = const Color(0xFF1F1E24);
